...
import '../../ganti_hari_list/application/ganti_hari_list_notifier.dart';
import '../application/absen_ganti_hari.dart';
import '../application/create_ganti_hari_notifier.dart';

class EditGantiHariPage extends HookConsumerWidget {
  const EditGantiHariPage(this.item);
    ...
    ref.listen<AsyncValue>(createGantiHariProvider, (_, state) async {
      if (!state.isLoading &&
        ...
        return AlertHelper.showSnackBar(
          ...
          message: 'Sukses Mengedit Form Ganti Hari',
          onDone: () {
      ...
      child: VAsyncWidgetScaffold<void>(
        ...
        data: (_) => VAsyncWidgetScaffold<void>(
          ...
          data: (_) => VScaffoldWidget(
              ...
              scaffoldTitle: 'Update Form Ganti Hari',
