...
DtPcList _$DtPcListFromJson(Map<String, dynamic> json) {
  return _DtPcList.fromJson(json);
}

/// @nodoc
mixin _$DtPcList {
  @JsonKey(name: 'id_dt')
  int? get idDt => throw _privateConstructorUsedError;
  @JsonKey(name: 'id_user')
  int? get idUser => throw _privateConstructorUsedError;
  String? get ket => throw _privateConstructorUsedError;
  @JsonKey(name: 'dt_tgl')
  String? get dtTgl => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $DtPcListCopyWith<DtPcList> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DtPcListCopyWith<$Res> {
  factory $DtPcListCopyWith(DtPcList value, $Res Function(DtPcList) then) =
      _$DtPcListCopyWithImpl<$Res, DtPcList>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DtPcListCopyWithImpl<$Res, $Val extends DtPcList>
    implements $DtPcListCopyWith<$Res> {
  _$DtPcListCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      idDt: freezed == idDt
          ? _value.idDt
          : idDt // ignore: cast_nullable_to_non_nullable
              as int?,
      ...
      dtTgl: freezed == dtTgl
          ? _value.dtTgl
          : dtTgl // ignore: cast_nullable_to_non_nullable
              as String?,
      jam: freezed == jam
          ? _value.jam
...
/// @nodoc
abstract class _$$_DtPcListCopyWith<$Res> implements $DtPcListCopyWith<$Res> {
  factory _$$_DtPcListCopyWith(
          _$_DtPcList value, $Res Function(_$_DtPcList) then) =
      __$$_DtPcListCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'id_dt') int? idDt,
...
/// @nodoc
class __$$_DtPcListCopyWithImpl<$Res>
    extends _$DtPcListCopyWithImpl<$Res, _$_DtPcList>
    implements _$$_DtPcListCopyWith<$Res> {
  __$$_DtPcListCopyWithImpl(
      _$_DtPcList _value, $Res Function(_$_DtPcList) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_DtPcList implements _DtPcList {
  const _$_DtPcList(
      {@JsonKey(name: 'id_dt') this.idDt,
      @JsonKey(name: 'id_user') this.idUser,
      this.ket,
      @JsonKey(name: 'dt_tgl') this.dtTgl,
      this.jam,
  ...
  factory _$_DtPcList.fromJson(Map<String, dynamic> json) =>
      _$$_DtPcListFromJson(json);
  ...
  @override
  String toString() {
    return 'DtPcList(idDt: $idDt, idUser: $idUser, ket: $ket, dtTgl: $dtTgl, jam: $jam, spvSta: $spvSta, spvNm: $spvNm, spvTgl: $spvTgl, hrdSta: $hrdSta, hrdNm: $hrdNm, hrdTgl: $hrdTgl, cDate: $cDate, cUser: $cUser, uDate: $uDate, uUser: $uUser, kategori: $kategori, spvNote: $spvNote, hrdNote: $hrdNote, periode: $periode, btlSta: $btlSta, btlNm: $btlNm, btlTgl: $btlTgl, appSpv: $appSpv, appHrd: $appHrd, uBy: $uBy, cBy: $cBy, idkar: $idkar, idDept: $idDept, payroll: $payroll, noTelp1: $noTelp1, noTelp2: $noTelp2, fullname: $fullname, dept: $dept, comp: $comp)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_DtPcList &&
            (identical(other.idDt, idDt) || other.idDt == idDt) &&
            (identical(other.idUser, idUser) || other.idUser == idUser) &&
            (identical(other.ket, ket) || other.ket == ket) &&
            (identical(other.dtTgl, dtTgl) || other.dtTgl == dtTgl) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DtPcListCopyWith<_$_DtPcList> get copyWith =>
      __$$_DtPcListCopyWithImpl<_$_DtPcList>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DtPcListToJson(
      this,
    );
  }
}

abstract class _DtPcList implements DtPcList {
  const factory _DtPcList(
      {@JsonKey(name: 'id_dt') final int? idDt,
      @JsonKey(name: 'id_user') final int? idUser,
      final String? ket,
      @JsonKey(name: 'dt_tgl') final String? dtTgl,
      final String? jam,
      ...
      final String? fullname,
      final String? dept,
      final String? comp}) = _$_DtPcList;

  factory _DtPcList.fromJson(Map<String, dynamic> json) = _$_DtPcList.fromJson;
